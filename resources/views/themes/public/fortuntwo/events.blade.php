...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('themes/public/' . ($publicTheme ?? 'fortuntwo') . '/css/events.css') }}">
    <link rel="stylesheet" href="{{ asset('themes/public/' . ($publicTheme ?? 'fortuntwo') . '/css/navigation.css') }}">
</head>
<body>
    @include('themes.public.fortuntwo.partials.miro-header', ['miroCurrentPage' => 'events'])
    @if(false)
                ...
                <div class="miro-events-grid">
                    @foreach($events as $event)
                        <article class="miro-event-card">
                            <div class="miro-event-card__visual" style="background:var(--fortun-{{ $event['tone'] }});">
                                <img src="{{ asset('themes/public/' . ($publicTheme ?? 'fortuntwo') . '/images/' . $event['photo']) }}" alt="{{ $event['title']['en'] }}" loading="lazy">
    ...
    <script src="{{ asset('themes/public/' . ($publicTheme ?? 'fortuntwo') . '/js/events.js') }}"></script>
</body>
</html>
