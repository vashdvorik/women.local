...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('themes/public/' . ($publicTheme ?? 'fortuntwo') . '/css/members.css') }}">
    <link rel="stylesheet" href="{{ asset('themes/public/' . ($publicTheme ?? 'fortuntwo') . '/css/navigation.css') }}">
</head>
<body>
    @include('themes.public.fortuntwo.partials.miro-header', ['miroCurrentPage' => 'members'])
    @if(false)
                ...
                <div class="miro-members-grid">
                    @foreach($profiles as $profile)
                        <article class="miro-public-member">
                            <div class="miro-public-member__visual" style="background:var(--fortun-{{ $profile['tone'] }});">
                                <img src="{{ asset('themes/public/' . ($publicTheme ?? 'fortuntwo') . '/images/' . $profile['photo']) }}" alt="{{ $profile['name']['en'] }}" loading="lazy">
                            </div>
    ...
    <script src="{{ asset('themes/public/' . ($publicTheme ?? 'fortuntwo') . '/js/members.js') }}"></script>
</body>
</html>
