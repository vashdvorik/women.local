...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('themes/public/' . ($publicTheme ?? 'fortuntwo') . '/images/brand/favicon.png') }}">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Noto+Sans:wght@400;500;600&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@phosphor-icons/web@2.1.2/src/regular/style.css">
    <script src="https://telegram.org/js/telegram-web-app.js"></script>
    <link rel="stylesheet" href="{{ asset('themes/public/' . ($publicTheme ?? 'fortuntwo') . '/css/landing.css') }}">
    <link rel="stylesheet" href="{{ asset('themes/public/' . ($publicTheme ?? 'fortuntwo') . '/css/navigation.css') }}">
</head>
<body>
    @include('themes.public.fortuntwo.partials.miro-header', ['miroCurrentPage' => 'home'])
    @if(false)
        ...
        <section class="miro-hero miro-hero--image">
            <div class="miro-container">
                <div class="miro-hero__grid">
                    <div class="fortun-floating-accents fortun-floating-accents--hero" aria-hidden="true"><span></span><span></span><span></span></div>
...
наставничества и развития бизнеса</span>
                    ...
                    <div class="miro-hero__visual" aria-label="Women entrepreneurs collaborating">
                        <div class="miro-hero__image">
                            <img src="{{ asset('themes/public/fortuntwo/images/herobaner.webp') }}" alt="Women entrepreneurs collaborating around a laptop">
                        </div>
                    </div>
                </div>
        ...
        <section class="fortun-director-note" aria-label="Message from the director">
            <div class="miro-container fortun-director-note__grid">
                ...
                <figure class="fortun-director-note__portrait">
                    ...
                    <img src="{{ asset('themes/public/fortuntwo/images/222.png') }}" alt="Елена Синика">
                </figure>
            </div>
        </section>
            ...
            <div class="miro-container miro-logo-wall__layout">
                ...
                <div class="miro-logo-wall__visual" aria-hidden="true">
                    <div class="miro-logo-wall__photo">
                        <img src="{{ asset('themes/public/' . ($publicTheme ?? 'fortuntwo') . '/images/333.png') }}" alt="">
                    </div>
            ...
            <div class="miro-container">
                <div class="miro-split">
                    <div class="miro-image-card">
                        <img src="{{ asset('themes/public/' . ($publicTheme ?? 'fortuntwo') . '/images/story-mentor.webp') }}" alt="Mentoring conversation" loading="lazy">
            ...
            <div class="miro-container">
                ...
                <div class="miro-grid-2">
                    <article class="miro-member-card">
                        <img src="{{ asset('themes/public/' . ($publicTheme ?? 'fortuntwo') . '/images/experts/expert-carolina.png') }}" alt="Carolina Bugaiyan" loading="lazy">
                        <div>
                    ...
                    <article class="miro-member-card">
                        <img src="{{ asset('themes/public/' . ($publicTheme ?? 'fortuntwo') . '/images/experts/expert-aurelia.png') }}" alt="Aurelia Salicov" loading="lazy">
                        <div>
                    ...
                    <article class="miro-member-card">
                        <img src="{{ asset('themes/public/' . ($publicTheme ?? 'fortuntwo') . '/images/experts/expert-vlada.png') }}" alt="Vlada Lysenko" loading="lazy">
                        <div>
                    ...
                    <article class="miro-member-card">
                        <img src="{{ asset('themes/public/' . ($publicTheme ?? 'fortuntwo') . '/images/experts/expert-zinaida.png') }}" alt="Zinaida Emelyanova" loading="lazy">
                        <div>
                ...
                <div class="miro-grid-2 miro-members__legacy">
                    <article class="miro-member-card">
                        <img src="{{ asset('themes/public/' . ($publicTheme ?? 'fortuntwo') . '/images/experts/expert-diana.png') }}" alt="Diana Sakirchuk" loading="lazy">
                        <div>
                    ...
                    <article class="miro-member-card">
                        <img src="{{ asset('themes/public/' . ($publicTheme ?? 'fortuntwo') . '/images/experts/expert-olga-melnichuk.png') }}" alt="Olga Melnichuk" loading="lazy">
                        <div>
                    ...
                    <article class="miro-member-card">
                        <img src="{{ asset('themes/public/' . ($publicTheme ?? 'fortuntwo') . '/images/experts/expert-irina.png') }}" alt="Irina Pleshkova" loading="lazy">
                        <div>
        ...
        <section class="miro-section miro-section--surface" id="stories">
            <div class="miro-container">
                <div class="miro-story">
                    <img src="{{ asset('themes/public/' . ($publicTheme ?? 'fortuntwo') . '/images/story-export.webp') }}" alt="Women entrepreneurs collaborating" loading="lazy">
    ...
    @include('themes.public.fortuntwo.partials.miro-footer')
    @if(false)
    ...
    <script src="{{ asset('themes/public/' . ($publicTheme ?? 'fortuntwo') . '/js/landing.js') }}"></script>
</body>
</html>
