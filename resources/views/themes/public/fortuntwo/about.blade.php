...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('themes/public/' . ($publicTheme ?? 'fortuntwo') . '/css/about.css') }}">
    <link rel="stylesheet" href="{{ asset('themes/public/' . ($publicTheme ?? 'fortuntwo') . '/css/navigation.css') }}">
</head>
<body>
    @include('themes.public.fortuntwo.partials.miro-header', ['miroCurrentPage' => 'about'])
    ...
    <main class="miro-about-page" id="about">
        <section class="miro-about-hero">
            <div class="miro-container miro-about-hero__inner">
                ...
                <div class="miro-about-hero__visual">
                    <img src="{{ asset('themes/public/' . ($publicTheme ?? 'fortuntwo') . '/images/hero-community.webp') }}" alt="Women entrepreneurs collaborating">
        ...
        <section class="miro-about-section">
            <div class="miro-container miro-about-split">
                <div class="miro-about-split__image"><img src="{{ asset('themes/public/' . ($publicTheme ?? 'fortuntwo') . '/images/story-mentor.webp') }}" alt="Mentorship and professional growth" loading="lazy"></div>
    ...
    <script src="{{ asset('themes/public/' . ($publicTheme ?? 'fortuntwo') . '/js/about.js') }}"></script>
</body>
</html>
