...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('themes/public/' . ($publicTheme ?? 'fortuntwo') . '/css/partners.css') }}">
    <link rel="stylesheet" href="{{ asset('themes/public/' . ($publicTheme ?? 'fortuntwo') . '/css/navigation.css') }}">
</head>
<body>
    @include('themes.public.fortuntwo.partials.miro-header', ['miroCurrentPage' => 'partners'])
                        ...
                        <div class="miro-partners-grid">
                            @foreach ($group['partners'] as $partner)
                                <article class="miro-partner-card miro-partner-card--{{ $group['tone'] }}">
                                    <div class="miro-partner-card__logo"><img src="{{ asset('themes/public/' . ($publicTheme ?? 'fortuntwo') . '/images/partners/' . $partner['image']) }}" alt="{{ $partner['name']['en'] }}" loading="lazy"></div>
    ...
    <script src="{{ asset('themes/public/' . ($publicTheme ?? 'fortuntwo') . '/js/partners.js') }}"></script>
</body>
</html>
