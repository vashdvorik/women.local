...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('themes/public/' . ($publicTheme ?? 'fortun') . '/css/about.css') }}">
    <link rel="stylesheet" href="{{ asset('themes/public/' . ($publicTheme ?? 'fortun') . '/css/navigation.css') }}">
</head>
<body>
    @include('themes.public.fortun.partials.miro-header', ['miroCurrentPage' => 'about'])
    ...
    <main class="miro-about-page" id="about">
        <section class="miro-about-hero">
            <div class="miro-container miro-about-hero__inner">
                ...
                <div class="miro-about-hero__visual">
                    <img src="{{ asset('themes/public/' . ($publicTheme ?? 'fortun') . '/images/hero-community.webp') }}" alt="Women entrepreneurs collaborating">
        ...
        <section class="miro-about-section">
            <div class="miro-container miro-about-split">
                <div class="miro-about-split__image"><img src="{{ asset('themes/public/' . ($publicTheme ?? 'fortun') . '/images/story-mentor.webp') }}" alt="Mentorship and professional growth" loading="lazy"></div>
    ...
    <script src="{{ asset('themes/public/' . ($publicTheme ?? 'fortun') . '/js/about.js') }}"></script>
</body>
</html>
