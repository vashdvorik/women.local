...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('themes/public/' . ($publicTheme ?? 'fortun') . '/css/events.css') }}">
    <link rel="stylesheet" href="{{ asset('themes/public/' . ($publicTheme ?? 'fortun') . '/css/navigation.css') }}">
</head>
<body>
    @include('themes.public.fortun.partials.miro-header', ['miroCurrentPage' => 'events'])
    @if(false)
                    ...
                    @foreach($events as $event)
                        <article class="miro-event-card">
                            <div class="miro-event-card__visual" style="background:var(--fortun-{{ $event['tone'] }});">
                                <img src="{{ asset('themes/public/' . ($publicTheme ?? 'fortun') . '/images/' . $event['photo']) }}" alt="{{ $event['title']['en'] }}" loading="lazy">
    ...
    <script src="{{ asset('themes/public/' . ($publicTheme ?? 'fortun') . '/js/events.js') }}"></script>
</body>
</html>
