...
colors:
  # Основные интерактивные цвета
  primary: "#1c1c1e"
  primary-hover: "#452074"
  primary-pressed: "#35165C"
  on-primary: "#FFFFFF"

  secondary: "#078890"
  secondary-hover: "#06767D"
  secondary-pressed: "#055E64"
  on-secondary: "#FFFFFF"

  # Основная брендовая палитра
  brand-purple-deep: "#261153"
  brand-purple: "#53288A"
  brand-purple-light: "#A78FC7"
  brand-purple-soft: "#E9E1F2"

  brand-teal: "#078890"
  brand-teal-dark: "#006A77"
  brand-teal-light: "#A4D0D4"
  brand-teal-soft: "#E2F2F3"

  brand-gold: "#DBA647"
  brand-gold-light: "#F1CE91"
  brand-gold-soft: "#FFF3D9"
  brand-gold-dark: "#9B6D1D"

  # Старые токены оставлены как алиасы
  brand-pink: "#E9E1F2"
  brand-coral: "#F1CE91"
  brand-blue: "#53288A"
  brand-rose: "#E9E1F2"
  ...
  brand-orange-light: "#FFF3D9"
  brand-red: "#E9E1F2"
  brand-red-dark: "#CFC1DD"

  # Акцентные и статусные цвета
  cream-accent: "#FFF3D9"
  accent-ink: "#261153"
  success-accent: "#078890"
  ...
  surface-pricing-featured: "#F5F0FA"
  ...
  # Текст на цветных и тёмных фонах
  on-dark: "#FFFFFF"
...
### Grid & Container
- Marketing pages use 1360px max-width with 32px gutters
