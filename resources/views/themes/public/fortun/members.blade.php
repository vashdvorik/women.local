...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('themes/public/' . ($publicTheme ?? 'fortun') . '/css/members.css') }}">
    <link rel="stylesheet" href="{{ asset('themes/public/' . ($publicTheme ?? 'fortun') . '/css/navigation.css') }}">
</head>
<body>
    @include('themes.public.fortun.partials.miro-header', ['miroCurrentPage' => 'members'])
    @if(false)
                    ...
                    @foreach($profiles as $profile)
                        <article class="miro-public-member">
                            <div class="miro-public-member__visual" style="background:var(--fortun-{{ $profile['tone'] }});">
                                <img src="{{ asset('themes/public/' . ($publicTheme ?? 'fortun') . '/images/' . $profile['photo']) }}" alt="{{ $profile['name']['en'] }}" loading="lazy">
                            </div>
    ...
    <script src="{{ asset('themes/public/' . ($publicTheme ?? 'fortun') . '/js/members.js') }}"></script>
</body>
</html>
