        ...
        <form method="POST" action="{{ route('account.opportunities.store') }}" class="miro-card miro-form-card">
            ...
            <div class="space-y-6">
                <div class="miro-form-field">
                    ...
                    @error('type')<p class="mt-2 text-xs font-medium text-[#8C4842]">{{ $message }}</p>@enderror
                </div>
                ...
                <div class="miro-form-field">
                    ...
                    @error('title')<p class="mt-2 text-xs font-medium text-[#8C4842]">{{ $message }}</p>@enderror
                </div>
                ...
                <div class="miro-form-field">
                    ...
                    @error('body')<p class="mt-2 text-xs font-medium text-[#8C4842]">{{ $message }}</p>@enderror
                </div>
                ...
                <div class="grid gap-6 md:grid-cols-2">
                    <div class="miro-form-field">
                        ...
                        @error('event_date')<p class="mt-2 text-xs font-medium text-[#8C4842]">{{ $message }}</p>@enderror
                    </div>
                    <div class="miro-form-field">
                        ...
                        @error('location')<p class="mt-2 text-xs font-medium text-[#8C4842]">{{ $message }}</p>@enderror
                    </div>
                </div>
                ...
                <div class="miro-form-field">
                    ...
                    @error('contact_url')<p class="mt-2 text-xs font-medium text-[#8C4842]">{{ $message }}</p>@enderror
                </div>
            </div>
