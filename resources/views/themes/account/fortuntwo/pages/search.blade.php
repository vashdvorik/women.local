    ...
    <form method="GET" action="{{ route('account.search') }}" class="miro-card p-4">
        <div class="flex flex-col gap-3 md:flex-row">
            <input
                ...
                class="h-10 min-h-10 flex-1 rounded-lg border border-slate-200 px-4 py-2 text-slate-900 outline-none transition"
            >
            <button class="miro-button miro-button--dark">
                        ...
                        <div class="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                            <div class="flex min-w-0 gap-4">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <h2 class="truncate text-xl font-medium tracking-tight text-[#261153]">{{ $person->full_name ?: __('account.not_specified') }}</h2>
