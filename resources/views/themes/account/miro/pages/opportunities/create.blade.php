            ...
            <div class="space-y-6">
                ...
                <div class="grid gap-6 md:grid-cols-2">
                    <div class="miro-form-field">
                        ...
                        @error('event_date')<p class="mt-2 text-xs font-medium text-red-600">{{ $message }}</p>@enderror
                    </div>
                    <div class="miro-form-field">
                ...
                <div class="miro-form-field">
                    ...
                    @error('contact_url')<p class="mt-2 text-xs font-medium text-red-600">{{ $message }}</p>@enderror
                </div>
            </div>

            <div class="mt-8 flex flex-col-reverse gap-3 border-t border-[#eef0f3] pt-6 sm:flex-row sm:justify-end">
