    ...
    <form action="{{ route('account.profile.update') }}" method="POST" class="miro-card miro-form-card">
        ...
        <div class="space-y-6">
            <div class="miro-form-field">
                ...
                @error('full_name')<p class="mt-2 text-xs font-medium text-red-600">{{ $message }}</p>@enderror
            </div>
            <div class="miro-form-field">
            ...
            <div class="miro-form-field">
                ...
                @error('expectation')<p class="mt-2 text-xs font-medium text-red-600">{{ $message }}</p>@enderror
            </div>
        </div>
