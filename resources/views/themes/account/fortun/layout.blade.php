...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('themes/account/fortun/images/brand/favicon.png') }}">
    ...
    <link rel="stylesheet" href="{{ asset('themes/account/fortun/css/theme.css') }}">
    @stack('head')
</head>
<body class="h-full bg-white text-[#1c1c1e] antialiased account-theme-fortun" x-data="{ sidebarOpen: false }">
        ...
        <aside x-cloak :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <div class="flex shrink-0 items-center gap-3 px-5 pb-5 pt-6">
                <span class="account-brand-mark flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-white p-0.5 shadow-sm">
                    <img src="{{ asset('themes/account/fortun/images/brand/favicon.png') }}" alt="Women Entrepreneurs Platform" class="h-full w-full object-contain">
                </span>
            ...
            <div class="account-user-card mx-3 mb-4 shrink-0 rounded-2xl p-4">
                <div class="flex items-center gap-3">
                    ...
                    @else
                        <div class="account-avatar-placeholder flex h-10 w-10 shrink-0 items-center justify-center rounded-full text-sm font-medium">
