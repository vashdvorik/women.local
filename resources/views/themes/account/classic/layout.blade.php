...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('themes/account/classic/images/brand/favicon.png') }}">
    ...
    <link rel="stylesheet" href="{{ asset('themes/account/classic/css/theme.css') }}">
    @stack('head')
</head>
<body class="h-full bg-[#f7f8fa] text-[#0f172a] antialiased account-theme-classic" x-data="{ sidebarOpen: false }">
        ...
        <aside x-cloak :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <div class="flex shrink-0 items-center gap-3 px-5 pb-5 pt-6">
                <span class="account-brand-mark flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-white p-0.5 shadow-sm">
                    <img src="{{ asset('themes/account/classic/images/brand/favicon.png') }}" alt="Women Entrepreneurs Platform" class="h-full w-full object-contain">
                </span>
